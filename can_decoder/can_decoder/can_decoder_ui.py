...
class CANDecoderUIWindow(QMainWindow):
    ...
    def refresh_layout(self):
        ...
        self.msg_labels[2].setText(
            f"STEER: {self.msg.steer:.2f} rad"
        )  # TODO: check units on this
        self.msg_labels[3].setText(
            f"STEER_RATE: {self.msg.steer_rate:.2f} rad/s"
        )  # TODO: check units on this
        self.msg_labels[4].setText(f"BRAKE: {self.msg.brake:.2f} %")
        self.msg_labels[5].setText(f"BRAKE_PRESSED: {self.msg.brake_pressed}")
        self.msg_labels[6].setText(
            f"YAW_RATE: {self.msg.yaw_rate:.2f} rad/s"
        )  # TODO: check units on this
